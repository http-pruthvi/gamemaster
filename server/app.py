...
"""
FastAPI application for the Gamemaster Env Environment.

This module creates an HTTP server that exposes the GamemasterEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m gamemaster_env.server.app
    ...
    multiple workers:
        uvicorn gamemaster_env.server.app:app --workers 4
    """
    import uvicorn
